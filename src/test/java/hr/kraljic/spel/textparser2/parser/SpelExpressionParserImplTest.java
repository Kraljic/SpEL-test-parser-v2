...
class SpelExpressionParserImplTest {
    ...
    SpelExpressionParser spelExpressionParser = new SpelExpressionParserImpl();

    @Test
    void parse_1() {
        String parsed = spelExpressionParser.parse(EXPRESSION_TEST_1);
    ...
    @Test
    void parse_2() {
        String parsed = spelExpressionParser.parse(EXPRESSION_TEST_2);
        System.out.println(parsed);
    ...
    @Test
    void parse_3() {
        String parsed = spelExpressionParser.parse(EXPRESSION_TEST_3);
        System.out.println(parsed);
